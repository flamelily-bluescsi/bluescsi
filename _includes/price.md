<div class="price-selector" style="background: #f8f9fa; border: 2px solid #004e92; border-radius: 8px; padding: 1.5rem; margin: 1.5rem 0;">
  ...
  {% elsif page.cart_name contains 'Alicia 1200' %}
    <option value="uk" data-price="{{site.aliciaukprice}}" data-sku="aliciauk">🇬🇧 UK Delivery - £{{site.aliciaukprice}} (PREORDER Dispatch Late December - 48hr tracked)</option>
    <option value="us" data-price="{{site.aliciausprice}}" data-sku="aliciaus">🇺🇸 US Delivery - £{{site.aliciausprice}} (PREORDER Dispatch Late December - Tariffs/Duties Paid)</option>
    <option value="row" data-price="{{site.aliciarowprice}}" data-sku="aliciarow">🌍 Rest of World - £{{site.aliciarowprice}} (PREORDER Dispatch Late December - International tracked)</option>
