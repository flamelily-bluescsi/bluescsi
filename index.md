...
Your registered Paypal delivery address will be used so please make sure it is correct before purchasing. You can see our current V2 stock on this page [CURRENT STOCK](/stock). Please see our page with info about [3D Prints](/print) for the BlueSCSI. If you need our Firmware Update service, this can be found here [Firmware Update](/firmware). Please download the PDF files below for instructions about usage and assembly.
