...
##### AdLib Module for the PicoMEM Card - (not needed for PicoMEM 2)
...
The [PicoMEM 2](/picomem2) does not need this module since it has the DAC (Digital to Analog converter) on board.
...
* NOT needed for a PicoMEM 2 
* Please choose the right purchase option below (&#9207;)

&#128221; STOCK COUNT: {{site.adlib}}
