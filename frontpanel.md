...
This is Front Panel for all the BlueSCSI Ultra devices, and the BlueSCSI V2 desktop (via QWIIC connector). You will need a QWIIC cable if buying for a V2 desktop. This Front Panel is an optional extension for all BlueSCSI boards (except DB25 and Powerbook) that was designed by Polpo for the [PicoIDE.](/picoide)
...
You also visit the documentation page here - [https://picoide.com/docs/front-panel/](https://picoide.com/docs/front-panel/){:target="_blank"} to see how it functions in the PicoIDE.
...
* Tested and complete
* Does NOT work for DB25 and Powerbook versions
