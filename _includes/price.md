<div class="price-selector" style="background: #f8f9fa; border: 2px solid #004e92; border-radius: 8px; padding: 1.5rem; margin: 1.5rem 0;">
  ...
  {% elsif page.cart_name contains 'PicoGUS' or page.cart_name contains 'PicoMEM' or page.cart_name contains 'PicoGX' or page.cart_name contains 'Midi' or page.cart_name contains 'CPU' or page.cart_name contains 'Expander' or page.cart_name contains 'VGA' or page.cart_name contains 'JuiceBox' or page.cart_name contains 'Front Panel' or page.cart_name contains 'Mister Floppy' or page.cart_name contains 'Slimline Floppy' or page.cart_name contains 'Audio for' %}
  ...
  {% elsif page.cart_name contains 'PowerShark' %}
   {% if site.powershark > 0 %}
    ...
    {% endif %}
  {% elsif page.cart_name contains 'T2' or page.cart_name contains 'HD68' or page.cart_name contains 'HD50' or page.cart_name contains 'Wide SCA' or page.cart_name contains 'CF Floppy' %}
    <option value="uk" data-price="{{page.cart_price_uk}}" data-sku="{{page.cart_itemid}}uk">🇬🇧 UK Delivery - £{{page.cart_price_uk}}</option>
