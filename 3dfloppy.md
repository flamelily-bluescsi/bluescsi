...
Please choose the correct option below for either purchasing this 3D print with a BlueSCSI device as postage is included. This is another option for the V2 Desktop, which is a lovely solid mounting bracket to fit in a 3.5 inch floppy drive bay. For Desktop PCB board revision 2023.10a ONLY. Print your own via the creator's Thingyverse page [here.](https://www.thingiverse.com/ellsworthbeast/designs){:target="_blank"}

* 3D PLA print (colour will vary)
* Solid mount, for 2023.10a and later revisions
